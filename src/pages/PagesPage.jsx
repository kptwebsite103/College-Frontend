...
export default function PagesPage() {
  ...
  useEffect(() => {
    ...
    const target =
      cardRefs.current[highlightId] ||
      document.getElementById(`page-card-${highlightId}`);
    if (target) {
  ...
  const handleApprovePage = async (pageId) => {
    try {
      if (!canReview) {
        showNotification(
          "error",
          "You do not have permission to approve pages.",
        );
        return;
      }
  ...
  const handleRejectPage = async (pageId) => {
    try {
      if (!canReview) {
        showNotification(
          "error",
          "You do not have permission to reject pages.",
        );
        return;
      }
            ...
            {loading ? (
              ...
              >
                ...
                <div style={{ fontSize: "14px" }}>
                  Please wait while we fetch your pages from the database.
                </div>
              </div>
...
export function AddEditPageForm({
  onSave,
  onCancel,
  showNotification,
  editingPage,
  ...
  useEffect(() => {
    if (editingPage && !formOpen) {
      setFormData({
        ...
        status:
          editingPage.status === "created"
            ? "pending"
            : editingPage.status || "pending",
        tags: Array.isArray(editingPage.tags) ? editingPage.tags : [],
        announcement_text_en:
          editingPage.announcement?.text?.en ||
          stripHtmlTags(editingPage.content?.en?.html || ""),
        announcement_text_kn:
          editingPage.announcement?.text?.kn ||
          stripHtmlTags(editingPage.content?.kn?.html || ""),
        ...
        announcement_attachment_url:
          editingPage.announcement?.attachmentUrl || "",
        announcement_attachment_label:
          editingPage.announcement?.attachmentLabel || "",
        css: editingPage.css || "",
        content_en: {
  ...
  const openEnglishPreview = () => {
    setEnPreviewDoc(
      buildEditablePreviewHTML(
        ...
        formData.content_en.javascript,
      ),
    );
  ...
  const openKannadaPreview = () => {
    setKnPreviewDoc(
      buildEditablePreviewHTML(
        ...
        formData.content_kn.javascript,
      ),
    );
  ...
  const handleSubmit = (e) => {
    ...
    if (!payload.slug) {
      if (showAnnouncementFields) {
        const base = slugifyText(
          payload.title_en || payload.title_kn || "announcement",
        );
        payload.slug = base
          ? `announcement-${base}-${Date.now()}`
    ...
    if (showAnnouncementFields) {
      ...
      if (!from || !to) {
        showNotification(
          "error",
          "Announcement start and end date are required.",
        );
        return;
      }
          ...
          <div style={{ display: "flex", gap: "4px" }}>
            <button
              ...
              style={{
                ...
                borderRadius: "6px",
                background:
                  enContentMode === "code" ? "#3B82F6" : "transparent",
            ...
            <button
              ...
              style={{
                ...
                borderRadius: "6px",
                background:
                  enContentMode === "preview" ? "#3B82F6" : "transparent",
            ...
            <div style={{ display: "flex", gap: "4px" }}>
              <button
                ...
                style={{
                  ...
                  borderRadius: "6px",
                  background:
                    enCodeTab === "single" ? "#8B5CF6" : "transparent",
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: "6px",
                  background:
                    enCodeTab === "javascript" ? "#F7DF1E" : "transparent",
          ...
          <div style={{ display: "flex", gap: "4px" }}>
            <button
              ...
              style={{
                ...
                borderRadius: "6px",
                background:
                  knContentMode === "code" ? "#3B82F6" : "transparent",
            ...
            <button
              ...
              style={{
                ...
                borderRadius: "6px",
                background:
                  knContentMode === "preview" ? "#3B82F6" : "transparent",
            ...
            <div style={{ display: "flex", gap: "4px" }}>
              <button
                ...
                style={{
                  ...
                  borderRadius: "6px",
                  background:
                    knCodeTab === "single" ? "#8B5CF6" : "transparent",
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: "6px",
                  background:
                    knCodeTab === "javascript" ? "#F7DF1E" : "transparent",
  ...
  const pickerItems = previewImageTarget
    ? mediaItems.filter(isImageMediaItem)
    : mediaItems;
          ...
          <>
            ...
            <div style={{ marginBottom: "20px" }}>
              ...
              {formData.announcement_attachment_url ? (
                <div style={{ marginTop: 8 }}>
                  <a
                    href={formData.announcement_attachment_url}
                    target="_blank"
                    rel="noreferrer"
                  >
        ...
        <div style={{ marginBottom: "20px" }}>
          ...
          >
            <input
              ...
              onChange={(event) =>
                handleAnnouncementToggle(event.target.checked)
              }
          ...
          {forceAnnouncement ? (
            <div style={{ marginTop: 6, fontSize: 12, color: "#6B7280" }}>
              Announcement mode is active from dashboard, so this is
